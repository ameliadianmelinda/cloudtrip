    ...
    <form action="{{ route('jadwal_penerbangan.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select class="form-select @error('pesawat_id') is-invalid @enderror" name="pesawat_id">
                ...
                @foreach ($pesawat as $p)
                    <option value="{{ $p->pesawat_id }}" {{ old('pesawat_id') == $p->pesawat_id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <select class="form-select @error('bandara_asal') is-invalid @enderror" name="bandara_asal">
                ...
                @foreach ($bandara as $b)
                    <option value="{{ $b->bandara_id }}" {{ old('bandara_asal') == $b->bandara_id ? 'selected' : '' }}>
                        {{ $b->nama_bandara }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-3">
            ...
            <select class="form-select @error('bandara_tujuan') is-invalid @enderror" name="bandara_tujuan">
                ...
                @foreach ($bandara as $b)
                    <option value="{{ $b->bandara_id }}" {{ old('bandara_tujuan') == $b->bandara_id ? 'selected' : '' }}>
                        {{ $b->nama_bandara }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tanggal_berangkat') is-invalid @enderror" 
                name="tanggal_berangkat" value="{{ old('tanggal_berangkat') }}">
        ...
        <div class="mb-3">
            ...
            <input type="time" class="form-control @error('waktu_berangkat') is-invalid @enderror" 
                name="waktu_berangkat" value="{{ old('waktu_berangkat') }}">
        ...
        <div class="mb-3">
            ...
            <input type="time" class="form-control @error('waktu_tiba') is-invalid @enderror" 
                name="waktu_tiba" value="{{ old('waktu_tiba') }}">
            @error('waktu_tiba')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
...
<div class="bg-white rounded shadow p-4">
    <form action="{{ route('jadwal_penerbangan.store') }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <select class="form-control @error('bandara_asal') is-invalid @enderror" name="bandara_asal">
                    <option value="">-- Pilih Bandara Asal --</option>
                    @foreach ($bandara as $b)
                        <option value="{{ $b->bandara_id }}" {{ old('bandara_asal') == $b->bandara_id ? 'selected' : '' }}>{{ $b->nama_bandara }} ({{ $b->kota }})</option>
                    @endforeach
                </select>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-control @error('bandara_tujuan') is-invalid @enderror" name="bandara_tujuan">
                    <option value="">-- Pilih Bandara Tujuan --</option>
                    @foreach ($bandara as $b)
                        <option value="{{ $b->bandara_id }}" {{ old('bandara_tujuan') == $b->bandara_id ? 'selected' : '' }}>{{ $b->nama_bandara }} ({{ $b->kota }})</option>
                    @endforeach
                </select>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <label class="form-label">Waktu Berangkat</label>
                <input type="time" class="form-control @error('waktu_berangkat') is-invalid @enderror" name="waktu_berangkat" value="{{ old('waktu_berangkat') }}">
                @error('waktu_berangkat') <small class="text-danger">{{ $message }}</small> @enderror
            </div>

            <div class="col-md-4 mb-3">
                <label class="form-label">Waktu Tiba</label>
                <input type="time" class="form-control @error('waktu_tiba') is-invalid @enderror" name="waktu_tiba" value="{{ old('waktu_tiba') }}">
